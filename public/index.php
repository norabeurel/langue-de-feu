...
use LangueDeFeu\LangueDeFeu;
$langueDeFeu = new LangueDeFeu();
$langueDeFeu->execute();
?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
  ...
  <div class="main width-container margin-auto">
    <div class="explanation-container">
      <h2
        class="title-2">Qu'est-ce ? :
      </h2>
      <p class="explanation">"Le javanais ou langue de feu, apparu en France dans la seconde moitié du XIXe siècle, est un procédé de codage argotique utilisant une phonologie parasitaire constituée par l'insertion d'une syllabe supplémentaire entre voyelles et consonnes, dans le but de rendre un énoncé moins compréhensible aux non initiés. Cette syllabe comporte un son lié au nom de la variante : « ja » ou « av » dans la variante « javanaise » et une syllabe comportant « f » dans la variante « langue de feu ». La difficulté réside tout autant dans l'habileté à placer les syllabes supplémentaires de façon naturelle dans la conversation que dans la compréhension orale. "</p>
      <p class="wikipedia-source">Source : <a href="https://fr.wikipedia.org/wiki/Javanais_(argot)" target="_blank">Wikipedia</a></p>
    </div>
    ...
    <div class="top-container">
      <div class="form-container">
        <form method="post" class="form">
          <div class="word-textarea <?php echo ($langueDeFeu->getErrorByFieldname("word")) ? "error" : "" ?>">
    ...
    <?php if (!empty($langueDeFeu->viewTransformWords())) : ?>
      <div class="response-container">
        <div class="response">
          <div class="response-title-container">
            <h2 class="response-title">Résultat :</h2>
          </div>
          <div class="response-text"><?php echo $langueDeFeu->viewTransformWords() ?></div>
  ...
  <footer class="footer">
    ...
    <a class="github-logo" href="https://github.com/norabeurel/langue-de-feu" target="_blank">
    ...
    <ul class="websites-link-container">
      <li><a class="louchebem-link" href="https://louchebem.bunchizz.com/" target="_blank">Louchebem</a></li>
      <li><a class="morse-link" href="https://morse.bunchizz.com/" target="_blank">Morse</a></li>
    </ul>
  </footer>
</body>
</html>
